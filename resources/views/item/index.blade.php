            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="card-title">Manajemen Item</h3>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ url('/item/new ') }}" class="btn btn-primary btn-sm float-right" style="margin:5px;">Tambah Data</a>&nbsp;&nbsp;
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ url('/item/' . $row->id) }}" method="POST">
                                            <!-- @csrf ADALAH DIRECTIVE UNTUK MEN-GENERATE TOKEN CSRF -->
                                            @csrf
                                            <input type="hidden" name="_method" value="DELETE" class="form-control">
                                            <a href="{{ url('/item/' . $row->id) }}" class="btn btn-warning btn-sm">Edit</a>
